!function(f) {
    ...
    var e = {
        init: function(t) {
            ...
            i += '<button type="button" data-mdtooltip="tooltip" title="' + (a = o).label.btnHeader1 + '" class="md-btn btn btn-default" data-btn="h1">H1</button>',
            i += '<button type="button" data-mdtooltip="tooltip" title="' + a.label.btnHeader2 + '" class="md-btn btn btn-default" data-btn="h2">H2</button>',
            i += '<button type="button" data-mdtooltip="tooltip" title="' + a.label.btnHeader3 + '" class="md-btn btn btn-default" data-btn="h3">H3</button>',
            i += "</div>",
            i += '<div class="btn-group">',
            i += '<button type="button" data-mdtooltip="tooltip" title="' + a.label.btnBold + '" class="md-btn btn btn-default" data-btn="bold"><span class="fas fa-bold"></span></button>',
            ...
            i += "</div>",
            i += '<div class="btn-group">',
            i += '<button type="button" data-mdtooltip="tooltip" title="' + a.label.btnList + '" class="md-btn btn btn-default" data-btn="ul"><span class="fas fa-list"></span></button>',
            i += '<button type="button" data-mdtooltip="tooltip" title="' + a.label.btnOrderedList + '" class="md-btn btn btn-default" data-btn="ol"><span class="fas fa-list-ol"></span></button>',
            i += "</div>",
            i += '<div class="btn-group">',
            i += '<button type="button" data-mdtooltip="tooltip" title="' + a.label.btnLink + '" class="md-btn btn btn-default" data-btn="link"><span class="fas fa-link"></span></button>',
            ...
            !0 === a.imageUpload && (i += '<div data-mdtooltip="tooltip" title="' + a.label.btnUpload + '" class="btn btn-default md-btn-file"><span class="fas fa-upload"></span><input class="md-input-upload" type="file" multiple accept=".jpg,.jpeg,.png,.gif"></div>'),
            i += "</div>",
            !0 === a.fullscreen && (i += '<div class="btn-group">',
            i += '<button type="button" class="md-btn btn btn-default" data-btn="fullscreen"><span class="fas fa-expand-arrows-alt"></span> ' + a.label.btnFullscreen + "</button>",
            i += "</div>"),
            !0 === a.preview && (i += '<div class="btn-group">',
            i += '<button type="button" class="md-btn btn btn-default btn-edit active" data-btn="edit"><span class="fas fa-edit"></span> ' + a.label.btnEdit + "</button>",
            i += '<button type="button" class="md-btn btn btn-default btn-preview" data-btn="preview"><span class="fas fa-eye"></span> ' + a.label.btnPreview + "</button>",
            i += "</div>"),
            i += '<div class="btn-group">', // Submit Button - kkamikoon
            i += '<button type="submit" data-mdtooltip="tooltip" title="' + a.label.Submit + '" class="md-btn btn btn-default">Submit</button>',
            i += "</div>",
            i += "</div>",
            i += "</div>",
