...
define("ace/selection", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/lib/event_emitter", "ace/range"], function(e, t, n) {
    ...
    (function() {
        ...
        this.$setSelection = function(e, t, n, r) {
            ...
            (this.$cursorChanged || this.$anchorChanged) && this._emit("changeSelection")
        }
        ,
...
define("ace/layer/font_metrics", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/lib/event_emitter"], function(e, t, n) {
    var r = e("../lib/oop")
      ...
      , u = e("../lib/event_emitter").EventEmitter
      , a = 256
      , f = typeof ResizeObserver == "function"
      , l = 200
      , c = t.FontMetrics = function(e) {
        ...
        f ? this.$addObserver() : this.checkForSizeChanges()
    }
    ;
    (function() {
        r.implement(this, u),
        ...
        this.$measureSizes = function(e) {
            var t = {
                ...
                width: (e || this.$measureNode).clientWidth / a
            };
        ...
        this.$initTransformMeasureNodes = function() {
            ...
            this.els = i.buildDom([e(0, 0), e(l, 0), e(0, l), e(l, l)], this.el)
        }
        ,
        this.transformCoordinates = function(e, t) {
            ...
            var a = u(this.els[0])
              ...
              , c = u(this.els[2])
              , h = u(this.els[3])
              , p = r(i(h, f), i(h, c), i(s(f, c), s(h, a)))
              , d = o(1 + p[0], i(f, a))
              , v = o(1 + p[1], i(c, a));
            if (t) {
                var m = t
                  , g = p[0] * m[0] / l + p[1] * m[1] / l + 1
                  , y = s(o(m[0], d), o(m[1], v));
                return s(o(1 / g / l, y), a)
            }
            var b = i(e, a)
